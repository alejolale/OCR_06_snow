 ...
 */
final class Version20220624084116 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentary (id INT AUTO_INCREMENT NOT NULL, trick_id_id INT NOT NULL, user_id_id INT NOT NULL, content VARCHAR(255) NOT NULL, enabled TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_1CAC12CAB46B9EE8 (trick_id_id), INDEX IDX_1CAC12CA9D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE trick_multimedia (id INT AUTO_INCREMENT NOT NULL, trick_id_id INT NOT NULL, source LONGBLOB NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_E8B9B8FEB46B9EE8 (trick_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
